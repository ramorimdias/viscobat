...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Reset/Refresh button clears stored data and inputs
  ...
  if (resetBtn) {
    resetBtn.addEventListener('click', () => {
      ...
      // Clear all form inputs and dynamic content
      document.querySelectorAll('form').forEach(form => {
        ...
        form.querySelectorAll('tbody').forEach(tb => (tb.innerHTML = ''));
      });
      ...
      if (tempCanvas) {
        ...
        cctx.clearRect(0, 0, tempCanvas.width, tempCanvas.height);
      }
    });
  }
